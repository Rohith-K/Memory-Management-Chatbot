...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot _chatBotInit("../images/chatbot.png");
    _chatBotInit.SetChatLogicHandle(this);
    _chatBotInit.SetRootNode(rootNode);
    this->SetChatbotHandle(&_chatBotInit);
    rootNode->MoveChatbotHere(std::move(_chatBotInit));
}
